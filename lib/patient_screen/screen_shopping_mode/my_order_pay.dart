...
class MyOrderPay extends StatefulWidget {
  static const String id = 'my_order_pay';

  @override
  _MyOrderPay createState() => _MyOrderPay();
}

class _MyOrderPay extends State<MyOrderPay>
