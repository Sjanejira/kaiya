...
class MyOrderShipping extends StatefulWidget {
  static const String id = 'my_order_shipping';

  @override
  _MyOrderShipping createState() => _MyOrderShipping();
}

class _MyOrderShipping extends State<MyOrderShipping>
