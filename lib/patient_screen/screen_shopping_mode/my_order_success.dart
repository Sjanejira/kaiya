...
class MyOrderSuccess extends StatefulWidget {
  static const String id = 'my_order_success';

  @override
  _MyOrderSuccess createState() => _MyOrderSuccess();
}

class _MyOrderSuccess extends State<MyOrderSuccess>
