...
class MyorderSelectShipping extends StatefulWidget {
  static const String id = 'patient_my_order_select_shipping';

  @override
  _MyorderSelectShipping createState() => _MyorderSelectShipping();
}

class _MyorderSelectShipping extends State<MyorderSelectShipping> {
  @override
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Container(
                                    margin:
                                        EdgeInsets.only(left: 15, bottom: 4),
                                    child: Text(
                                      'KaiYa',
                                      style: TextStyle(
                                        fontSize: 15,
