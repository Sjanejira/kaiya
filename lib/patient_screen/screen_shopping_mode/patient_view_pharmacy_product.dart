...
class ViewPharmaProduct extends StatefulWidget {
  static const String id = 'view_pharmacy_product';
  @override
  _ViewPharmaProduct createState() => _ViewPharmaProduct();
}

class _ViewPharmaProduct extends State<ViewPharmaProduct> {
  @override
