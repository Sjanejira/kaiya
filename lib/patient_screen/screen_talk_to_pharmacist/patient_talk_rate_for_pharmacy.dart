...
class RateForPharma extends StatefulWidget {
  static const String id = 'patient_fill_rate';
  @override
  _RateForPharma createState() => _RateForPharma();
}

class _RateForPharma extends State<RateForPharma> {
  @override
