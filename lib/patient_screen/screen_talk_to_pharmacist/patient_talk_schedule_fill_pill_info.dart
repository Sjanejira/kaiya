...
class PillFillInfo extends StatefulWidget {
  static const String id = 'patient_fill_pill_info';
  @override
  _PillFillInfo createState() => _PillFillInfo();
}

class _PillFillInfo extends State<PillFillInfo> {
  @override
