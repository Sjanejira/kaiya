...
class ChatWithMoreOrder extends StatefulWidget {
  static const String id = 'in_chat_with_more';
  @override
  _ChatWithMoreOrder createState() => _ChatWithMoreOrder();
}

class _ChatWithMoreOrder extends State<ChatWithMoreOrder> {
  @override
