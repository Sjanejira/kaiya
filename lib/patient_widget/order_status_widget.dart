...
import 'package:kaiya/patient_widget/item_box_widget.dart';
import 'package:kaiya/patient_widget/order_status_box_widget.dart';
        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (typeoforder == OrderStatus.pay.index)
                OrderStatusBox(
              ...
              if (typeoforder == OrderStatus.success.index)
                OrderStatusBox(
...
enum OrderStatus { pay, preparing, shipping, success }
