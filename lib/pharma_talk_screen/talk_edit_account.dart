...
class TalkEditAcccount extends StatefulWidget {
  static const String id = 'talk_edit_account';

  @override
  _TalkEditAcccount createState() => _TalkEditAcccount();
}

class _TalkEditAcccount extends State<TalkEditAcccount> {
  bool _lights = true;
  bool _darks = true;
  bool _greys = true;
  int selectedValue;
